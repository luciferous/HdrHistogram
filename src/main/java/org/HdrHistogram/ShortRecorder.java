...
public class ShortRecorder implements ValueRecorder {
    ...
    private volatile ShortCountsHistogram activeHistogram;
    private ShortCountsHistogram inactiveHistogram;
     ...
     */
    //public ShortRecorder(final int numberOfSignificantValueDigits) {
     ...
     *                                       and separation. Must be a non-negative integer between 0 and 5.
     */
    public ShortRecorder(final long highestTrackableValue,
     ...
     *                                       and separation. Must be a non-negative integer between 0 and 5.
     */
    public ShortRecorder(final long lowestDiscernibleValue,
     ...
     */
    public synchronized ShortCountsHistogram getIntervalHistogram() {
     ...
     * @return a histogram containing the value counts accumulated since the last interval histogram was taken.
     */
    public synchronized ShortCountsHistogram getIntervalHistogram(ShortCountsHistogram histogramToRecycle) {
    ...
    public synchronized ShortCountsHistogram getIntervalHistogram(ShortCountsHistogram histogramToRecycle,
        ...
        ShortCountsHistogram sampledHistogram = inactiveHistogram;
     ...
     */
    public synchronized void getIntervalHistogramInto(ShortCountsHistogram targetHistogram) {
        performIntervalSample();
    ...
    private void performIntervalSample() {
        try {
            ...
            final ShortCountsHistogram tempHistogram = inactiveHistogram;
    ...
    private class InternalAtomicHistogram extends AtomicShortCountsHistogram {
    ...
    private void validateFitAsReplacementHistogram(ShortCountsHistogram replacementHistogram,
                                                   boolean enforeContainingInstance) {
        boolean bad = true;
