...
public class AtomicShortCountsHistogram extends ShortCountsHistogram {

    static final AtomicLongFieldUpdater<AtomicShortCountsHistogram> totalCountUpdater =
            AtomicLongFieldUpdater.newUpdater(AtomicShortCountsHistogram.class, "totalCount");
    ...
    @Override
    public AtomicShortCountsHistogram copy() {
        AtomicShortCountsHistogram copy = new AtomicShortCountsHistogram(this);
        copy.add(this);
        return copy;
    }

    @Override
    public AtomicShortCountsHistogram copyCorrectedForCoordinatedOmission(final long expectedIntervalBetweenValueSamples) {
        AtomicShortCountsHistogram toHistogram = new AtomicShortCountsHistogram(this);
     ...
     */
    public AtomicShortCountsHistogram(final long highestTrackableValue, final int numberOfSignificantValueDigits) {
     ...
     *                                       and separation. Must be a non-negative integer between 0 and 5.
     */
    public AtomicShortCountsHistogram(final long lowestDiscernibleValue, final long highestTrackableValue, final int numberOfSignificantValueDigits) {
     ...
     */
    public AtomicShortCountsHistogram(final AbstractHistogram source) {
        super(source, false);
        counts = new AtomicLongArray(countsArrayLength);
        wordSizeInBytes = 8;
    }
     ...
     */
    public static AtomicShortCountsHistogram decodeFromByteBuffer(final ByteBuffer buffer,
                                                       final long minBarForHighestTrackableValue) {
        return (AtomicShortCountsHistogram) decodeFromByteBuffer(buffer, AtomicShortCountsHistogram.class,
     ...
     */
    public static AtomicShortCountsHistogram decodeFromCompressedByteBuffer(final ByteBuffer buffer,
                                                                 final long minBarForHighestTrackableValue) throws DataFormatException {
        return decodeFromCompressedByteBuffer(buffer, AtomicShortCountsHistogram.class, minBarForHighestTrackableValue);
    }
